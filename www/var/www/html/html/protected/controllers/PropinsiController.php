...
class PropinsiController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Propinsi']))
		{
			...
			$nama_prop = $_POST['Propinsi']['propinsi'];
			$cmd = Yii::app()->db->createCommand();
			$cmd->insert('Propinsi',array('propinsi'=>$nama_prop));
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Propinsi']))
		{
			...
			$nama_prop = $_POST['Propinsi']['propinsi'];
			$cmd = Yii::app()->db->createCommand();
			$cmd->update('Propinsi',array('propinsi'=>$nama_prop), 'id=:id', array(':id'=>$id));
			$this->redirect(array('admin'));
	...
	{
		$cmd = Yii::app()->db->createCommand();
			$cmd->delete('Propinsi','id=:id', array(':id'=>$id));
	 ...
	 * @param Propinsi $model the model to be validated
	 */
